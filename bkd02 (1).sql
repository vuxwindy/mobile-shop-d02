...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th2 08, 2025 lúc 04:29 PM
...
CREATE TABLE `ads` (
  ...
  `ads_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `ads_mail` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `ads_detali` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `ads` (`ads_id`, `ads_name`, `ads_mail`, `ads_detali`, `price`, `status`, `date`) VALUES
(1, 'vua nệm', 'nemv@gmail.com', 'san phảm tốt nhất đén từ vua nệm', 99999999, b'1', '2025-02-07 16:20:46');
...
INSERT INTO `comment` (`comm_id`, `prd_id`, `comm_name`, `comm_mail`, `comm_date`, `comm_details`, `status`) VALUES
(1, 1, 'Nguyễn Văn A', 'nguyenvana@gmail.com', '2018-12-12 20:59:56', 'Đây thực sự là một sản phẩm tuyệt vời', b'1'),
(2, 2, 'Nguyễn Băn B', 'banb@gmail.com', '2018-12-12 20:59:56', 'good', b'1');
...
CREATE TABLE `orders` (
  ...
  `cus_mail` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `cus_address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `orders` (`order_id`, `cus_name`, `cus_phone`, `cus_mail`, `cus_address`, `quantity`, `prd_id`, `total_price`, `status`, `date`) VALUES
(1, 'minh hạnh', 123456789, 'hanhm@gmail.com', '86 ho chi minh cty', 5, 1, 99999, b'1', '2025-02-06 08:53:52'),
(2, 'văn ngôn', 123456789, 'ngonv@gmail.com', '90 trần phú hà nội', 1, 12, 989899, b'1', '2025-02-06 08:53:52'),
(3, 'độc lập', 123456789, 'lapd@gmail.com', '90 doan van', 2, 20, 99999, b'0', '2025-02-06 16:32:16'),
(4, 'tự do', 123456789, 'dot@gmail.com', '90 van quan', 1, 6, 989899, b'0', '2025-02-06 16:32:16');
...
(28, 5, 'SONY XPERIA PRO-I BLACK', 'sony-xperia-1-dual-sim.jpg', 20000000, '2 năm', 'ốp lưng, tai nghe, sạc.', 'còn hàng', '20%', 1, 0, 'Màn hình OLED 4K HDR 21:9 6,5 inch 120 Hz\r\n'),
(33, 6, 'td', 'anh-thien-nhien.jpg', 4294967295, '2 năm', 'dây sạc', 'mới', 'co', 1, 1, 'moi');
...
(2, 'Nguyễn Van A', 'vana@gmail.com', '123456', 0),
(7, 'Anpha Mart', 'manpha@gmail.com', '123456', 0),
(8, 'Nguyễn Ban B', 'banb@gmail.com', '123456', 0),
(9, 'Anpha Mart', 'anpha@gmail.com', '123456', 0),
(10, 'Alan DR.Storn', 'alanD@gmail.com', '$2y$10$nDN/5zJ/hMnMmrhXiB8sqeHG5iYRWSiqPY4wC88ONpV8oiuJHx/qq', 0);
